...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "How to Decode Rental Ads",
    description:
      "Navigate the world of rental ads with confidence. Learn how to interpret terms like 'apartment for rent' and 'house for rent' to unlock the best options for your lifestyle.",
    url: "https://www.hapartment.com/blogs/how-to-decode-rental-ads",
    siteName: "Hapartment",
    images: [
      {
        url: "/listings/one.jpg",
        width: 1200,
        height: 630,
        alt: "How to Decode Rental Ads",
      },
    ],
    locale: "en_NG",
    type: "article",
  ...
  twitter: {
    ...
    title: "How to Decode Rental Ads",
    description:
      "Discover how to decode rental ads — from 'apartment for rent' to 'house for rent' — and make your next rental search smarter and stress-free.",
    images: ["/listings/one.jpg"],
  },
  alternates: {
    canonical: "https://www.hapartment.com/blogs/how-to-decode-rental-ads",
  },
};
