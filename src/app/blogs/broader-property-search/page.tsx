...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: "Decoding Property for Rent and Rental Properties: A Broader Perspective for Your Search",
        description:
            "Expand your property search beyond specific dwelling types by understanding 'property for rent' and 'rental properties'. These comprehensive terms offer a wider lens into the market, encompassing everything from residential homes and apartments to commercial spaces, providing a holistic view of available leases across Nigeria.",
        url: "https://www.hapartment.com/blogs/broader-property-search",
        siteName: "Hapartment",
        images: [
            {
                url: "/images/blog-property-rental.jpg",
                width: 1200,
                height: 630,
                alt: "Property for Rent and Rental Properties",
            },
        ],
        locale: "en_NG",
        type: "article",
    ...
    twitter: {
        ...
        title:
            "Decoding Property for Rent and Rental Properties: A Broader Perspective for Your Search",
        description:
            "Expand your property search beyond specific dwelling types by understanding 'property for rent' and 'rental properties'. These comprehensive terms offer a wider lens into the market across Nigeria.",
        images: ["/images/blog-property-rental.jpg"],
    },
    alternates: {
        canonical: "https://www.hapartment.com/blogs/broader-property-search",
    },
};
