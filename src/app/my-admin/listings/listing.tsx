...
const ListingContent = () => {
    ...
    }, [page, search, property_type, min_price, max_price, sort, sorting, dispatch, PageSize]);

    useEffect(() => {
        fetchListings();
    }, [fetchListings, state.callback]);
    ...
    const updateQuery = (params: Record<string, any>) => {
        ...
        router.push(`/listings?${currentQuery.toString()}`);
    };
